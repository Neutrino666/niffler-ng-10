...
public class ProfilePage {
    ...
    private final ElementsCollection activeCategories = $$(".MuiGrid-item:has(.MuiChip-filled.MuiChip-colorPrimary)");
    private final ElementsCollection archiveCategories = $$(".MuiGrid-item:has(.MuiChip-filled.MuiChip-colorDefault)");
    ...
    public ProfilePage clickRegisterPasskey() {
        registerPasskeyBtn.shouldBe(interactable, visible).click();
        return this;
    }

    @Step("Save changes")
    public ProfilePage clickSaveChanges() {
        saveChangesBtn.shouldBe(interactable, visible).click();
        return this;
    }
    ...
    public ProfilePage setName(@NonNull final String name) {
        nameInput.shouldBe(visible, editable).val(name);
        return this;
    }
    ...
    public ProfilePage checkActiveCategoriesIsDisplayedInAnyOrder(@NonNull final String... categories) {
    ...
    @Step("Check categories contains in any order: '{categories}'")
    public ProfilePage checkArchivedCategoriesIsDisplayedInAnyOrder(@NonNull final String... categories) {
        showArchive(true);
        for (String category : categories)
    ...
    public ProfilePage editActiveCategory(@NonNull final String fromCategory, @NonNull final String toCategory) {
        activeCategories.findBy(text(fromCategory))
                .find(getCategoryBtn(CategoryButton.Edit))
                .shouldBe(interactable, visible)
                .click();
