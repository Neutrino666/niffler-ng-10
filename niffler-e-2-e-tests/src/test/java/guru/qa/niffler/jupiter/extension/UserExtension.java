...
public class UserExtension implements BeforeEachCallback, ParameterResolver {
        ...
        .ifPresent(
            userAnno -> {
              if (userAnno.username().isEmpty()) {
                ...
                List<UserJson> income = userClient.createIncomeInvitation(user, userAnno.incomeInvitations());
                List<UserJson> outcome = userClient.createOutcomeInvitation(user, userAnno.outcomeInvitations());
  ...
  @Override
  public UserJson resolveParameter(@Nonnull ParameterContext parameterContext,
